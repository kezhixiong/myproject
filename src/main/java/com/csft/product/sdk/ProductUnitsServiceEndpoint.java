...
public class ProductUnitsServiceEndpoint {
	...
	public void deleteUnits(Callback<Object> callback,@PathVariable("unitId") String unitId,Map<String,String> body){
		
		
		//调试日志
		logger.debug(">>>>>>>>>>>>>>>>Delete units :unitId is:{},param is {}",unitId,body);
