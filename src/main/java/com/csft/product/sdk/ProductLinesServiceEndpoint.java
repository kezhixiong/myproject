...
public class ProductLinesServiceEndpoint {
	...
	public void deleteLines(Callback<Object> callback,@PathVariable("lineId") String lineId,Map<String,String> body){
		
		
		//调试日志
		logger.debug("Delete lines :lineId is:{},param is {}",lineId,body);
