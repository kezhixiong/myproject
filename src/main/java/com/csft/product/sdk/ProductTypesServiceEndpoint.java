...
public class ProductTypesServiceEndpoint {
	...
	public void deleteType(Callback<Object> callback,@PathVariable("typeId") String typeId,Map<String,String> body){
		
		
		//调试日志
		logger.debug(">>>>>>>>>>>>>>>>Delete types :typeId is:{},param is {}",typeId,body);
