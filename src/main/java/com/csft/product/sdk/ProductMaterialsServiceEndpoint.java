...
public class ProductMaterialsServiceEndpoint {
	...
	public void deleteMaterials(Callback<Object> callback,@PathVariable("lineId") String lineId,Map<String,String> body){
		
		
		//调试日志
		logger.debug("Delete materials :materialId is:{},param is {}",lineId,body);
