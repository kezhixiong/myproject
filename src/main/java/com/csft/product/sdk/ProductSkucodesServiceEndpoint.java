...
public class ProductSkucodesServiceEndpoint {
	...
	public void deleteSkucode(Callback<Object> callback,@PathVariable("skuCode") String skuCode,Map<String,String> body){
		
		
		//调试日志
		logger.debug(">>>>>>>>>>>>>>>>Delete skuCode :skuCode is:{},param is {}",skuCode,body);
